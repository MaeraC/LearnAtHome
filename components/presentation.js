function presentation() {
    ...
    presentationSection.innerHTML= `
        ...
        <div class="avantages-presentation row-reverse">
            <img src="../assets/banner.jpg" alt="Professeur avec son élève" />
            <article>
        ...
        <div class="avantages-presentation">
            <img src="../assets/presentation7.jpg" alt="Elève qui lève la main" />
            <article>
        ...
        <div class="avantages-presentation row-reverse">
            <img src="../assets/presentation3.jpg" alt="Professeur avec son élève" />
            <article>
